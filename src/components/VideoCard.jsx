  ...
  return (
    <>
      ...
      `}>
        {/* ── Thumbnail (clickable) ── */}
        <div
          className="relative aspect-video w-full overflow-hidden bg-gray-100 dark:bg-gray-700 cursor-pointer"
          onClick={handlePlay}
          title={t.playVideo}
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center
            ...
            <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-200
                            bg-white/90 dark:bg-black/80 rounded-full p-3 shadow-lg">
        ...
        <div className="flex flex-col flex-1 p-4 gap-2">
          ...
          {/* Title (clickable) */}
          <h3
            className="text-sm font-semibold text-gray-900 dark:text-white line-clamp-2 leading-snug
