export const translations = {
  ar: {
    ...
    login: 'تسجيل الدخول',
    logout: 'تسجيل الخروج',
    email: 'البريد الإلكتريني',
    password: 'كممة المرور',
    ...
    language: 'English',
    checkEmail: 'تحقق من بريدك الإلكتريني لتأكيد الحساب.',
    emailPlaceholder: 'أدخل بريدك الإلكتريني',
